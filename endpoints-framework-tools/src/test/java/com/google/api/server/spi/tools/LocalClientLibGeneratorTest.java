...
public class LocalClientLibGeneratorTest {
  ...
  public void testInvalidDiscoveryFile_fails() throws Exception {
    ...
    File destinationDir = tmpFolder.newFolder("destination");
    Assert.assertThrows(IOException.class, () -> generator.generateClientLib(discoveryDoc, "java", null, null, destinationDir));
  }
  ...
  public void testDestinationIsFile_fails() throws Exception {
    ...
    Assert.assertThrows(IOException.class, () -> generator.generateClientLib(discoveryDoc, "java", null, null, destinationFile));
  }
