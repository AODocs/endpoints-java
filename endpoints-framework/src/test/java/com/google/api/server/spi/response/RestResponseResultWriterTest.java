...
public class RestResponseResultWriterTest {
  ...
  public void writeError_extraFields() throws Exception {
    ...
    // Extra field string
    serviceException.addExtraField("someExtraString", "string1").addExtraField("someNullString", (String)null);
    // Extra field number
    serviceException.addExtraField("someExtraInt", Integer.valueOf(12)).addExtraField("someExtraFloat", Float.valueOf(1.2f)).addExtraField("someNullNumber", (Number)null);
    // Extra field boolean
    serviceException.addExtraField("someExtraTrue", TRUE).addExtraField("someExtraFalse", FALSE).addExtraField("someNullBoolean", (Boolean)null);
    // Extra field, keys are equals to reserved keywords when ignoring case
    serviceException.addExtraField("Domain", TRUE).addExtraField("REASON", Long.valueOf(1234567890)).addExtraField("messAge", "hello world!");
