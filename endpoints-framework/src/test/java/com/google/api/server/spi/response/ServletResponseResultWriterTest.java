  ...
  public void testTypeChangesInBeanAsString() throws Exception {
    Object value = new Object() {
      ...
      public Map<Long,List<Long>> getDeeplyNonEmptyMapList_IncludeNonEmpty() {
        return ImmutableMap.of(12L, ImmutableList.of(12L));
      }
      @JsonInclude(value = JsonInclude.Include.NON_EMPTY)
      public Map<Long,Long[]> getDeeplyNonEmptyMapArray_IncludeNonEmpty() {
        return ImmutableMap.of(12L, new Long[] {12L});
      }
    };
    ...
    assertPathPresent("{\"12\":[\"12\"]}", output.path("deeplyNonEmptyMapList_IncludeNonEmpty"));
    assertPathPresent("{\"12\":[\"12\"]}", output.path("deeplyNonEmptyMapArray_IncludeNonEmpty"));
  }
